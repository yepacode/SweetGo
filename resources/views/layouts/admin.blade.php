        ...
        <nav class="p-4 space-y-1 overflow-y-auto" style="height: calc(100vh - 4rem);">
            @php
                ...
                if ($esAdmin) {
                    ...
                    $modules[] = ['label' => 'Catálogo',  'route' => 'catalogo.index',   'icon' => 'M12 6.5A2.5 2.5 0 0114.5 4H21v14h-6.5a2.5 2.5 0 00-2.5 2.5M12 6.5A2.5 2.5 0 009.5 4H3v14h6.5a2.5 2.5 0 012.5 2.5M12 6.5v14'];
